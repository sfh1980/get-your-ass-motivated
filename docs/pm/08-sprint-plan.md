...
## Sprint 1 — PM pack + dogfood (current)
...
| Sean | Dogfood Today; PII-review screenshots; Sunday status |
| Agents | Scope guard on new features; doc updates as assigned |
| Exit | docs/pm + remap + screenshots done; dogfood ≥5 days; grab checklist reviewed |

### Sprint 1 backlog (pull)
...
4. [ ] Dogfood Today ≥5 days this sprint  
5. [x] Portfolio screenshots (8 via Playwright)  
6. [x] Multi-purpose + progress documentation (SoT §1 + `00-…`)  
7. [ ] PII-review screenshots + case-study metrics  
8. [ ] Sunday status/RAID refresh  
