...
| Hiring managers | Case study + sanitized artifacts | Future portfolio site (from `portfolio-export/`) | When publishing | Sean |
| Mentors / LinkedIn | High-level progress | LinkedIn / messages | Per roadmap networking tasks | Sean |

## Meeting substitutes (solo)

| Ceremony | Solo equivalent |
|----------|-----------------|
| Daily standup | 5-min note: yesterday / today / blocker (optional in `portfolio-export/notes/`) |
